...
const LogoType = () => {
    ...
    return (
        <svg ref={anchorRef} width="846" height="144" viewBox="0 0 846 144" fill="none">
            ...
            {/* <rect className={styles.eyelidLeftBottom} x="163" y="92" width="80" height="40" fill="red" /> */}
            <rect className={styles.eyelidRight} x="433" y="52" width="80" height="80" fill="white" />
            {/* <rect className={styles.eyelidRightBottom} x="433" y="92" width="80" height="40" fill="yellow" /> */}
